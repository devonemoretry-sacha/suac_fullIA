...
| | |
|---|---|
| **Ancrage** | **Événementiel** — non posé sur la map. Dispose d'un budget d'apparitions par contrat et se manifeste à un endroit différent à chaque fois (cf. 2.5.7). |
| **Signature** | Visible de tous. Le premier contact visuel **de chaque joueur** déclenche son propre choc audiovisuel. |
| **Entrée** | Le regard (le ralentit) + le volume (le déclenche) |
| **Réaction** | Avance vers le joueur le plus proche. Ralenti tant qu'un regard le tient. Crie — localement. Un bruit émis par un joueur qui le regarde → charge → capture. |
| **Prévention** | Le regarder, et se taire |
| **Levier** | Parler à un coéquipier qui le fixe, pour le faire craquer |

##### Le cri est strictement local

Il n'est entendu que des joueurs qui regardent la créature. Les autres n'entendent rien.
...
- **Il crée un rôle émergent que personne n'a écrit.** Un joueur figé qui fixe un point, sans pouvoir s'expliquer, produit chez les autres une inquiétude qu'aucun script ne pourrait écrire. Et parce qu'ils n'entendent rien, ils **lui parlent** — ce qui le fait craquer. **Le Guetteur est l'habitant qui utilise l'entraide comme arme.**

##### Chacun paie son propre regard

La créature est visible de tous, mais **tout joueur qui pose les yeux dessus déclenche son propre screamer**.

On ne peut donc pas empiler les regards gratuitement : le relais doit être une passation, jamais un groupe qui fixe ensemble. Et le joueur qui jette un œil par curiosité — parce qu'un coéquipier fixe obstinément un coin de la pièce — se prend le choc en pleine figure.

C'est la source comique principale de l'archétype : la curiosité est punie, mais elle est irrésistible, et l'équipe finit à plusieurs à reculer d'une pièce en silence.

##### La pression, et la jauge

Ce qui dure n'est pas une attente à intensité constante, c'est une **montée**. Le son enfle, la créature se rapproche par saccades, l'écran se charge. Le joueur ne compte pas les secondes : il se demande combien il en supporte encore.

**Une seule jauge, portée par la créature et non par le joueur.** Elle se remplit tant qu'au moins un regard la tient, et ne redescend pas lors d'un relais. Un joueur qui craque ne remet pas le compteur à zéro — il meurt ou déclenche la charge, mais le travail des autres n'est pas perdu.

À huit joueurs, tenir est mécaniquement plus facile. C'est assumé : chaque relais coûte un screamer de plus, donc une chance de plus que quelqu'un craque. Le nombre n'aide jamais gratuitement.

##### Les deux issues

**A — Le repli à reculons.** Le regard ne fige pas, il ralentit : on ne gagne pas sur place. Le joueur doit **sortir de la zone en marchant à reculons, sans le lâcher des yeux**. Reculer à l'aveugle, c'est cogner le décor, trébucher, faire du bruit — et en ragdoll, c'est une machine à comédie.

**B — Tenir jusqu'au bout.** La jauge se remplit entièrement : **le Guetteur craque le premier**. Il panique, se retourne et détale bruyamment. La pièce est dégagée pour le reste du contrat.

**Pourquoi les deux existent.** Le repli est la sortie de secours : un joueur perdu, qui ne connaît pas la pièce ou ne sait pas encore qu'il peut fuir, n'est jamais condamné à rester bloqué là toute la partie. Un joueur averti sort vite et ne perd pas de temps ; un débutant coincé finit toujours par s'en extraire.

**L'arbitrage réel.** Dans un jeu de déménagement, **on repasse toujours** — quatre fois, avec un piano dans les bras, en mode dégradé.

| | Coût immédiat | Ce que ça achète |
|---|---|---|
| **Reculer** | Rien | Rien. Il est toujours là, et on reviendra les mains pleines. |
| **Tenir** | Un long moment sans porteur disponible, et un bruit franc à la fin | La pièce est dégagée pour le reste du contrat. |

C'est une décision d'investissement, posée au pire moment : quand l'équipe est encore fraîche et n'a pas envie de perdre trente secondes.

##### La fuite

Le Guetteur qui craque produit **un bruit franc à son point de départ**, et rien d'autre. Il ne traverse pas le niveau, ne réveille pas un Squatteur, ne déclenche pas une Porte.

**Le bruit de fuite n'attire que les Patrouilleurs.** C'est une conséquence volontairement bornée : elle suffit à faire comprendre à toute l'équipe — y compris à ceux qui n'ont rien vu — qu'il vient de se passer quelque chose et qu'il faut bouger, sans ouvrir une cascade incontrôlable.

##### Le cas du porteur

**Aucune règle spécifique.** Un joueur qui porte peut tenir le regard, et la physique du transport (2.4.2) suffit à gérer la situation : si deux porteurs tirent dans des directions opposées, ils ne vont nulle part et se disputent une zone étroite, façon tir à la corde.

C'est exactement l'effet recherché. Le binôme ne comprend pas pourquoi son coéquipier recule, ne voit rien, n'entend rien, et finit par lâcher un « mais bouge, qu'est-ce que tu fous ?! » — qui est précisément le bruit qui fait craquer l'autre.
...
#### Entités placées et entités événementielles

Le bestiaire se répartit en deux familles, qui ne se règlent pas avec le même curseur.

**Les entités placées** sont posées par le level design : le Patrouilleur a un circuit, l'Embusqué un recoin, la Porte un seuil, le Squatteur un meuble. La difficulté vient de **leur nombre et de leur emplacement**.

**Les entités événementielles** ne sont pas posées. Elles disposent d'un **budget d'apparitions** par contrat et se manifestent à un endroit différent à chaque fois. La difficulté vient de **leur fréquence**.

Trois bénéfices :
- **Un seul chiffre à régler par contrat**, aucun placement manuel. Une apparition en contrat une étoile, trois en contrat quatre étoiles : le curseur de difficulté est direct et lisible.
- **La rejouabilité est native.** Deux parties sur la même map ne produisent pas les mêmes rencontres.
- **Une victoire ne retire pas la menace du contrat**, elle consomme une apparition. On a gagné la pièce, pas la mission.

**Contrainte opposable — la zone vide.** Une entité événementielle n'apparaît que dans une **zone où ne se trouve aucun joueur**. Peu importe que la zone ait déjà été explorée : une pièce nettoyée n'est jamais définitivement sûre.

- **Ce que la règle interdit** : le pop-in. Aucun joueur ne doit voir une entité se matérialiser. Elle est toujours **découverte**, jamais **surgie**.
- **Ce que la règle autorise volontairement** : réoccuper une pièce dans laquelle l'équipe a confiance. C'est l'intérêt principal de l'archétype événementiel dans un jeu où l'on repasse constamment — la route d'extraction, parcourue les mains pleines et sans pouvoir communiquer, redevient une inconnue à chaque passage.

*Complément à confirmer : la zone doit probablement être vide **et hors de toute ligne de vue** — un joueur qui regarde depuis un couloir dans une pièce déserte verrait apparaître la créature, ce qui reproduit le pop-in que la règle cherche à éviter.*

Le **Guetteur** est le premier archétype événementiel identifié. L'**Imitateur** en est un candidat naturel — *point ouvert*.

#### Règles de peuplement

Le nombre d'habitants placés n'est jamais une variable directe. Doubler les menaces ne double pas la difficulté : cela superpose les zones de danger et produit des configurations sans route sûre. Le joueur ne perd plus par erreur, il perd par tirage.
...
- **Endurance du regard sur le Guetteur** : durée de remplissage de la jauge, et courbe exacte de la montée en pression *(tuning en playtest)*.
- **Budget d'apparitions du Guetteur** par palier de réputation.
- **L'Imitateur est-il événementiel** plutôt que placé (cf. 2.5.7) ?
